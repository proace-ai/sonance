...
const NowPlayingBar: React.FC<NowPlayingBarProps> = ({
  ...
  return (
    <motion.div
      className="bg-gray-900/90 backdrop-blur-md text-white rounded-xl px-3 sm:px-6 py-3 sm:py-3 border border-zinc-800/40 shadow-md w-[calc(100%-1.5rem)] sm:w-full mx-auto cursor-pointer hover:bg-gray-900/95 transition-colors fixed sm:relative bottom-1 sm:bottom-auto left-0 right-0 sm:left-auto sm:right-auto pb-4 sm:pb-4 sm:mb-0"
      onClick={onExpand}
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <motion.div 
          className="flex items-center justify-end w-1/4 sm:w-1/4"
          initial={{ opacity: 0, x: 10 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.3 }}
        >
